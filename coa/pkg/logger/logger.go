...
func NewLogger(name string) Logger {
	...
	if !ok {
		if os.Getenv("REMOTE_AGENT") != "" {
			logger = newRemoteAgentLogger(name, hooks.ContextHookOptions{DiagnosticLogContextEnabled: true, ActivityLogContextEnabled: false, Folding: true})
		} else {
